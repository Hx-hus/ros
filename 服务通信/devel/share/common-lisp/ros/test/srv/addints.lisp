...
(cl:defmethod cl:initialize-instance :after ((m <addints-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'addints-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<addints-request> is deprecated: use test-srv:addints-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <addints-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'addints-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<addints-response> is deprecated: use test-srv:addints-response instead.")))
