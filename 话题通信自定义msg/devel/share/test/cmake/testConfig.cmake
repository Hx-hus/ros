...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/hx-hus/ros/ros/话题通信自定义msg/src/test)
  set(test_DEVEL_PREFIX /home/hx-hus/ros/ros/话题通信自定义msg/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/hx-hus/ros/ros/话题通信自定义msg/install)
...
if(NOT "/home/hx-hus/ros/ros/话题通信自定义msg/devel/include " STREQUAL " ")
  set(test_INCLUDE_DIRS "")
  set(_include_dirs "/home/hx-hus/ros/ros/话题通信自定义msg/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'hx-hus <hx-hus@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hx-hus/ros/ros/话题通信自定义msg/src/test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hx-hus/ros/ros/话题通信自定义msg/devel/lib;/opt/ros/noetic/lib)
