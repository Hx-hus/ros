...
if(NOT "/home/hx-hus/ros/ros/话题通信基本操作/devel/include " STREQUAL " ")
  set(test_INCLUDE_DIRS "")
  set(_include_dirs "/home/hx-hus/ros/ros/话题通信基本操作/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hx-hus/ros/ros/话题通信基本操作/src/test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hx-hus/ros/ros/话题通信基本操作/devel/lib;/opt/ros/noetic/lib)
